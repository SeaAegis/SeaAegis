...
import 'package:seaaegis/maps/nearbyplaceslistscreen.dart';

class SelectedBeachData extends StatefulWidget {
  final LatLng beachcoor;
  SelectedBeachData({super.key,
  required this.beachcoor
  });

  @override
  _SelectedBeachDataState createState() => _SelectedBeachDataState();
}
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          for (int i = 0; i < resultsLength; i++) {
            ...
            fetchphotos(fsqid.isNotEmpty
                                    ? fsqid[0]
                                    : "Unknown ID");

            fetchreviews(fsqid.isNotEmpty
                                    ? fsqid[0]
                                    : "Unknown ID");
          }
          }
                      ...
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(child: IconButton(
                                  ...
                                  icon:  Icon(Icons.favorite, color: isfav ? Colors.red : Colors.black, size: 30,)))
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(child: Text(beachlocation, style: const TextStyle(fontSize: 20),)),
                              ],
                            ),
                            const SizedBox(height: 10,),
                            Text(isopen.isNotEmpty ? isopen[0] : "No status available", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.blue),),
                          ...
                          : const Text("No photos available"),
                            ...
                            const Text("Reviews", style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600, color: Colors.red),),
                            // const SizedBox(height: 10),
                ...
                : const Text("No reviews found"),
                            ...
                            Center(
                              child: ElevatedButton(
                                ...
                                child: const Center(child: Text("Near By Places", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),)),
                              )),
                            )
                          ]
                        ),
