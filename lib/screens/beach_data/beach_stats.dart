...
import 'package:seaaegis/screens/beach_data/widgets/alert_box.dart';
import 'package:seaaegis/screens/beach_data/widgets/hourly_data.dart';
import 'package:seaaegis/screens/beach_data/widgets/weather_info.dart';
import 'package:seaaegis/screens/maps/mapsscreen.dart';
        ...
        child: Column(
          ...
          children: [
                      ...
                      children: [
                        condition.isSafeToVisit()
                            ? const Image(
                                ...
                                width: 140,
                                image: AssetImage(
                                    'assets/weather/safeweather.png'),
                              )
                            : Lottie.asset('assets/weather/unsafe.json',
                                width: 140, height: 150, fit: BoxFit.cover),
                        Column(
            ...
            WeatherInfoGrid(
              ...
              highlighters: condition.getSafetyIssues()["highlighter"],
            ),
          ],
        ),
      ),
